...
```{r}
# box plot on no response x existing credits
boxplot(NO_GC$NUM_CREDITS,
main = "Number of existing credits for people refused in the bank",
xlab = "Number of existing credits",
ylab = "German credits refused",
col = "orange",
border = "brown",
horizontal = TRUE,
notch = TRUE
